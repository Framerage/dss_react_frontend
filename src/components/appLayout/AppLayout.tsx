...
const AppLayout: React.FC = () => {
  ...
  //TODO: дополнить личную страницу, сортировка заказов по дате, имени, статусу ABC/CBA
  ...
  //TODO: страница заказа,настройка сообщения для почты(позиции, кол-во, цена) добавить оплату
