...
const AppLayout: React.FC = () => {
  ...
  //TODO: дополнить бек для сохранения заказов( авторизация, валидация, сортировка списка заказов по переданным айдишникам, сделать счетчик заказов), отправка сообщения на почту, добавить оплату
  //TODO: дополнить страницу заказа, при успешном оформлении заказа очищать корзину юзера, добавить оповещение что смс ушло на почту, перенос юзера в каталог
